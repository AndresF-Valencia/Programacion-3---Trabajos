defmodule Sudoku do
  @doc """
  Este módulo resuelve un Sudoku usando el algoritmo de backtracking.
  El tablero se representa como una lista de listas de números (4x4),
  donde el número 0 significa que la celda está vacía.
  """
